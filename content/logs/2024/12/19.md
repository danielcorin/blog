...
{{< bluesky link="https://bsky.app/profile/danielcorin.com/post/3ldosi76gts2n" >}}

To create this animation for a day in the mind of Claude Sonnet, generated the HTML with this Python script, captured with PNGs with `puppeteer`, then used `ffmpeg` to stitch them together.
